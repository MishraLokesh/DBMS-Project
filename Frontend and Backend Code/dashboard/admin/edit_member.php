...
<head>
    ...
    <title>अखाडा STUDIO | Edit Member</title>
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<div class="logo">
				...
				<a href="#" class="sidebar-collapse-icon with-animation" class="with-animation"><!-- add class "with-animation" if you want sidebar to have animation during expanding/collapsing transition -->
